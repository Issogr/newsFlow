...
const it: TranslationDictionary = {
  ...
  adminOverview: 'Panoramica account',
  adminOnlineHelp: ({ minutes }) => `Online indica attività negli ultimi ${minutes} minuti.`,
  adminAutoRefresh: ({ seconds }) => `Aggiornamento ogni ${seconds} secondi.`,
  adminUsersTitle: 'Utenti',
  adminAccount: 'Admin',
  adminAccountProtected: 'Non eliminabile',
  adminApiActivity: 'Attività API',
  adminActions: 'Azioni',
  adminUserActions: ({ username }) => `Azioni per ${username}`,
  adminSetupLinkReadyFor: ({ username }) => `Link di reimpostazione password per ${username}`,
  adminResetLinkHelp: 'Condividi questo link con l’utente per consentirgli di scegliere una nuova password.',
  adminCopyLinkError: 'Impossibile copiare il link. Selezionalo e copialo manualmente.',
  ...
  adminNoActivity: 'Nessuna attività',
  adminNoUsers: 'Nessun utente trovato.',
  adminUsersUnavailable: 'Impossibile caricare gli utenti. Prova ad aggiornare.',
