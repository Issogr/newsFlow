...
export const translations = {
  en: {
    ...
    liveDisabled: 'Off',
    refresh: 'Refresh',
    refreshWithUpdates: ({ count }) => `Refresh, ${count} new ${count === 1 ? 'group' : 'groups'} available`,
  ...
  it: {
    ...
    liveDisabled: 'Spento',
    refresh: 'Aggiorna',
    refreshWithUpdates: ({ count }) => `Aggiorna, ${count} nuovi ${count === 1 ? 'gruppo disponibile' : 'gruppi disponibili'}`,
