...
export const translations = {
  en: {
    ...
    authOrLocal: 'or local account',
    clerkMergeTitle: 'Unify with a local account',
    clerkMergeHelp: 'After signing in with Clerk, log in to the local account you want to keep. Its settings and sources become the unified account.',
    clerkMergeAction: 'Unify accounts',
    clerkMergeSkip: 'Not now',
    clerkMergeSuccess: 'Accounts unified. Your local settings are now linked to Clerk.',
    googleAuthRedirectTitle: 'Completing Google sign-in',
    googleAuthRedirectBody: 'Please wait while News Flow completes your Google authentication and returns you to the app.',
  ...
  it: {
    ...
    googleLoginAction: 'Continua con Google',
    authOrLocal: 'o account locale',
    clerkMergeTitle: 'Unifica con un account locale',
    clerkMergeHelp: 'Dopo l\'accesso con Clerk, accedi all\'account locale che vuoi mantenere. Le sue impostazioni e fonti diventano l\'account unificato.',
    clerkMergeAction: 'Unifica account',
    clerkMergeSkip: 'Non ora',
    clerkMergeSuccess: 'Account unificati. Le impostazioni locali sono ora collegate a Clerk.',
    googleAuthRedirectTitle: 'Completamento accesso Google',
    googleAuthRedirectBody: 'Attendi mentre News Flow completa l\'autenticazione con Google e ti riporta nell\'app.',
