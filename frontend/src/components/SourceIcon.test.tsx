...
describe('SourceIcon', () => {
  test('uses the same sized container for image and fallback icons', () => {
    ...
    expect(imageContainer).toHaveClass('box-border', 'h-10', 'w-10', 'overflow-hidden', 'rounded-full', 'bg-surface-raised', 'ring-1', 'ring-inset');
    expect(fallbackContainer).toHaveClass('box-border', 'h-10', 'w-10', 'overflow-hidden', 'rounded-full', 'bg-surface-raised', 'ring-1', 'ring-inset');
