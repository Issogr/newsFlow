...
import { submitFeedback as submitFeedbackImplementation } from '../services/api';
...
const submitFeedback = vi.mocked(submitFeedbackImplementation);

function renderFeedbackModal(locale: Locale = 'en') {
  return render(
    <FeedbackModal
