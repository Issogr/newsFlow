...
const DEFAULT_PANEL_CLASS_NAME = 'ml-auto flex h-[100dvh] w-full flex-col overflow-hidden bg-white shadow-xl sm:h-full sm:max-w-2xl sm:rounded-2xl sm:border sm:border-slate-200';
