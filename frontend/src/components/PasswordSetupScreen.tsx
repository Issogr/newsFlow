...
function getSetupErrorMessage(error: unknown, t: Translator) {
...
type TokenDetails = { valid?: boolean; username?: string; purpose?: string; expiresAt?: string };

const PasswordSetupScreen = ({ t, token, onComplete }: { t: Translator; token: string; onComplete: (user: CurrentUser) => void | Promise<void> }) => {
