...
export const READER_TEXT_SIZE_STYLES = {
  small: {
    ...
    blockquote: 'border-l-4 border-stone-300 bg-stone-50 pl-5 pr-2 italic text-[0.98rem] leading-7 text-stone-700',
  ...
  medium: {
    ...
    blockquote: 'border-l-4 border-stone-300 bg-stone-50 pl-5 pr-2 italic text-stone-700',
  ...
  large: {
    ...
    blockquote: 'border-l-4 border-stone-300 bg-stone-50 pl-5 pr-2 italic text-[1.08rem] leading-8 text-stone-700',
