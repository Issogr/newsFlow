...
export const READER_TEXT_SIZE_STYLES: Record<ReaderTextSize, Record<string, string>> = {
  small: {
    paragraph: 'text-[1rem] leading-[1.65] text-reader-ink',
    blockquote: 'border-l-4 border-reader-line bg-reader-surface pl-5 pr-2 italic text-[0.98rem] leading-[1.65] text-reader-muted',
    preformatted: 'overflow-x-auto rounded-2xl bg-stone-900 px-4 py-4 text-[0.85rem] leading-6 text-stone-100',
    list: 'text-[0.96rem] leading-[1.65] text-reader-ink',
    headingLevel1: 'text-xl md:text-2xl',
    headingLevel3: 'text-lg md:text-xl',
    headingOther: 'text-base'
  },
  medium: {
    paragraph: 'text-[1.08rem] leading-[1.65] text-reader-ink',
    blockquote: 'border-l-4 border-reader-line bg-reader-surface pl-5 pr-2 italic leading-[1.65] text-reader-muted',
    preformatted: 'overflow-x-auto rounded-2xl bg-stone-900 px-4 py-4 text-sm leading-7 text-stone-100',
    list: 'text-[1.04rem] leading-[1.65] text-reader-ink',
    headingLevel1: 'text-2xl md:text-3xl',
    headingLevel3: 'text-xl md:text-2xl',
    headingOther: 'text-lg'
  },
  large: {
    paragraph: 'text-[1.18rem] leading-[1.65] text-reader-ink',
    blockquote: 'border-l-4 border-reader-line bg-reader-surface pl-5 pr-2 italic text-[1.08rem] leading-[1.65] text-reader-muted',
    preformatted: 'overflow-x-auto rounded-2xl bg-stone-900 px-4 py-4 text-[1rem] leading-7 text-stone-100',
    list: 'text-[1.12rem] leading-[1.65] text-reader-ink',
