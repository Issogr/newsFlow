export const CURRENT_CHANGELOG_ENTRY = {
  ...
  en: {
    ...
    items: [
      ...
      '⚙️ Settings and Feedback now use flatter layouts, while Reader and AI summaries add narrower prose, shared text sizing, compact citations and source controls, and fewer fixed distractions.',
  ...
  it: {
    ...
    items: [
      ...
      '⚙️ Impostazioni e Feedback ora usano layout piu piatti; Lettore e riepiloghi AI aggiungono testo piu stretto, dimensioni condivise, citazioni e fonti compatte e meno distrazioni fisse.',
