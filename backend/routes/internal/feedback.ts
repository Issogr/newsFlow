...
function validateFeedbackAttachment(file: Express.Multer.File | null | undefined) {
  if (!file) {
    return;
  }
...
router.post('/me/feedback', [requireAuthenticatedUser, feedbackRateLimit, handleFeedbackUpload], async (req: Request, res: Response) => {
