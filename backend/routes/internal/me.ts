...
router.get('/me/api-token', [requireAuthenticatedUser, requireAuthenticatedPublicApiFeature], async (req: Request, res: Response) => {
  res.json({ apiToken: userService.getUserApiToken(req.user.id) });
});

router.post('/me/api-token', [requireAuthenticatedUser, requireAuthenticatedPublicApiFeature], async (req: Request, res: Response) => {
...
router.delete('/me/api-token', [requireAuthenticatedUser, requireAuthenticatedPublicApiFeature], async (req: Request, res: Response) => {
