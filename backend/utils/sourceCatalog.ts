...
function extractRegistrableDomain(url: string) {
...
function deriveCommonName(names: string[] = []) {
...
function deriveGroupName(sources: SourceDefinition[] = [], domain = '') {
...
function deriveSubSourceLabel(source: SourceDefinition, groupName: string, memberCount: number) {
  if (source.subSource) {
...
function buildDomainSourceGroups(
  sources: SourceDefinition[] = [],
  options: { includeLegacyIds?: boolean } = {}
...
function resolveConfiguredSource(sourceId: string, sourceName: string) {
